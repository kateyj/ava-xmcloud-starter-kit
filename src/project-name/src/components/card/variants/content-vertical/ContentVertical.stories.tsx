...
const meta: Meta<typeof ContentVerticalCard> = {
  title: 'Components/Card/Content Vertical',
  component: ContentVerticalCard,
};

export default meta;
type Story = StoryObj<typeof ContentVerticalCard>;
